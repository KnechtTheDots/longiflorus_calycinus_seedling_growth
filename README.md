...
Conda and snakemake must be installed (the snakemake version used for this analysis is 9.16.3, anything newer should work). See snakemake installation instructions at [snakemake.readthedocs.io](https://snakemake.readthedocs.io/) for more information.  

Once conda and snakemake are installed and this repository is downloaded, the analysis can be generated by executing the following command in the shell from within the main directory.
